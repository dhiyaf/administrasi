	...
	<div class="container" style="border: 2px solid black; width: 90%;">
		<div class="header-form">
			<div class="row">
				...
				<h3 align="center" style="text-transform: uppercase;"><b>DATA PELAMAR KATEGORI <?php echo $_GET['jenis']; ?></b></h3>
			</div>
		</div>
		<div> 
		<div class="body-form">
			<div class="row" style="margin: 2% 2%;">
				<table class="table" id="tabel" >
					...
					<tbody>
			            ...
			            $i=1;
			            $query = " SELECT * FROM data where jenis='$jenis' and keterangan='diproses' and tanggal between '$tgl_awal' and '$tgl_akhir' order by id_data desc";
